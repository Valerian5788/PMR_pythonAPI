"""
Django settings for PMR_pythonAPI project.
...
WSGI_APPLICATION = 'PMR_pythonAPI.wsgi.application'
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'mycaches',  # Specify the name of the database table for caching
    }
}
